...
public class Scenario_2003_Executor implements ScenarioExecutor {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(Scenario_2003_Executor.class);
    ...
    public void executeScenario(KeyValue<String, String> kv, KeyValueStore<String, String> store) {
        ...
        if (isCurrentDay(targetEventTime)) {
            ...
            if (event_1300_Exists && eventTimeFits(event_1300_Key, targetEventTime, store)) {
                ...
                if (isPushTime(event_1300_server_time, push_period)) {
